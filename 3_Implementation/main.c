...
int main()
    ...
    mainhome:
        ...
        */
        ...
        printf("\n -------------------------------------------------------------------------------------");
        printf("\n\n\n >> Game starts with the first question with multiple choice. \n ");
        printf("\n\n >> In this round you will be asked a total of 10 questions. Each right answer will be awarded $100,000!");
        printf("\n >> You will be given 4 options and you have to press A, B ,C or D for the right option.");
        printf("\n >> You will be asked questions continuously, till right answers are given");
        printf("\n >> No score reduction for wrong answers!");
        printf("\n\n\t!!!!!!!!!!!!! ALL THE BEST !!!!!!!!!!!!!");
